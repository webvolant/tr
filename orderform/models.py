...
class Order(models.Model):
	...
	name = models.CharField(verbose_name=_(u'Ваше Имя'),max_length=240)
	...
	doc_file = models.FileField(verbose_name=_(u"Загрузите ваш документ"), upload_to='media', blank='true')
